 ...
 */
public class BiologicalInferences extends DataPlotDialog
{
  ...
  public void refreshVariableList()
  {
    ...
    if (datasetValid)
    {
      ...
      {
        Logger.getLogger(BiologicalInferences.class.getName()).log(Level.SEVERE, null, ex);
      }
  ...
  {
    String cmd = "library(bio.infer); flist.match('^coef');";
  ...
  public void refreshCoefRegDataList()
  {
    Object currentDataset = coefRegDataComboBox.getSelectedItem();
    Object[] datasets = null;

    try
    {
      datasets = RUtils.ls("list");

      if (datasets != null && datasets.length > 0)
      {
        coefRegDataComboBox.setModel(new DefaultComboBoxModel(datasets));
      }
      else
      {
        coefRegDataComboBox.removeAllItems();
      }

      if (coefRegDataComboBox.getModel().getSize() > 0)
      {
        if (currentDataset != null)
        {
          coefRegDataComboBox.setSelectedItem(currentDataset);
        }
        else
        {
          coefRegDataComboBox.setSelectedIndex(0);
        }
      }
    }
    catch (REngineException ex)
   ...
   */
    ...
    private void initComponents() {
        ...
        coefRegDataRadioButton = new javax.swing.JRadioButton();
        coefRegDataLabel = new javax.swing.JLabel();
        coefRegDataComboBox = new javax.swing.JComboBox();
        coefRegDataBrowseButton = new javax.swing.JButton();
        ...
        coefPane.setBorder(javax.swing.BorderFactory.createTitledBorder("Coefficient Data"));

        coefDatabuttonGroup.add(coefBioInferDataRadioButton);
        coefBioInferDataRadioButton.setSelected(true);
        coefBioInferDataRadioButton.setText("Select a coefficient dataset from the bio.infer package:");
        ...
        coefBioInferDataLabel.setText("bio.infer dataset:");

        coefDatabuttonGroup.add(coefRegDataRadioButton);
        coefRegDataRadioButton.setText("Select a your coefficient dataset or upload a new one:");
        coefRegDataRadioButton.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                coefRegDataRadioButtonStateChanged(evt);
            }
        });
        coefRegDataRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                coefRegDataRadioButtonActionPerformed(evt);
            }
        });

        coefRegDataLabel.setText("dataset:");

        coefRegDataComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                coefRegDataComboBoxActionPerformed(evt);
            }
        });

        coefRegDataBrowseButton.setText("Browse...");
        coefRegDataBrowseButton.setMargin(new java.awt.Insets(0, 10, 0, 10));
        coefRegDataBrowseButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                coefRegDataBrowseButtonActionPerformed(evt);
            }
        });
        ...
        coefPaneLayout.setHorizontalGroup(
            ...
            .addGroup(coefPaneLayout.createSequentialGroup()
                ...
                .addGroup(coefPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(coefPaneLayout.createSequentialGroup()
                        .addGroup(coefPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(coefPaneLayout.createSequentialGroup()
                            ...
                            .addGroup(coefPaneLayout.createSequentialGroup()
                                .addComponent(coefRegDataLabel)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(coefRegDataComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(coefRegDataRadioButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(coefRegDataBrowseButton)))
        ...
        coefPaneLayout.setVerticalGroup(
            ...
            .addGroup(coefPaneLayout.createSequentialGroup()
                ...
                .addGroup(coefPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(coefBioInferDataLabel))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(coefRegDataRadioButton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(coefPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(coefRegDataComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(coefRegDataLabel)
                    .addComponent(coefRegDataBrowseButton))
        ...
        resultName.setText("pecboResult");
        ...
        setTitle("Predicting Env. Conditions from Bio. Observations (PECBO)");
...
private void coefRegDataBrowseButtonActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_coefRegDataBrowseButtonActionPerformed
{//GEN-HEADEREND:event_coefRegDataBrowseButtonActionPerformed
...
}//GEN-LAST:event_coefRegDataBrowseButtonActionPerformed
...
private void coefRegDataRadioButtonStateChanged(javax.swing.event.ChangeEvent evt)//GEN-FIRST:event_coefRegDataRadioButtonStateChanged
{//GEN-HEADEREND:event_coefRegDataRadioButtonStateChanged
  this.refreshCoeffValidity();
}//GEN-LAST:event_coefRegDataRadioButtonStateChanged

private void coefRegDataRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coefRegDataRadioButtonActionPerformed
  this.refreshCoeffValidity();
}//GEN-LAST:event_coefRegDataRadioButtonActionPerformed

private void coefRegDataComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_coefRegDataComboBoxActionPerformed
  this.refreshSubmitButtonValidity();
}//GEN-LAST:event_coefRegDataComboBoxActionPerformed
    ...
    private javax.swing.JButton coefRegDataBrowseButton;
    private javax.swing.JComboBox coefRegDataComboBox;
    private javax.swing.JLabel coefRegDataLabel;
    private javax.swing.JRadioButton coefRegDataRadioButton;
